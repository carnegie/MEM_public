...
def Macro_Energy_Model(path,i):
    ...
    if len(sys.argv) == 1:
        ...
        case_input_path_filename = path+str(i)+'h.csv'
        #case_input_path_filename = './case_input/case_input_Toktarova/W+S/WesternAfrica/case_input_example_'+str(i)+'h.csv'
    else:
