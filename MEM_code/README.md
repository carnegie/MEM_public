...
This is a Macro Energy Model that optimizes electricity (or electricity
and fuels) without considering any spatial variation, policy, capacity markets, etc.


Please refer to the wiki for documentation: https://github.com/carnegie/MEM/wiki including links to the cost files.
...
-- Echo input csv file in summary text files of output
...
Python 3.7 (or 3.6!) and cvxpy 1.x version of MEM 2. .NOTE that version 3.8.8 does not work as of 2021-10-25.

You can download older versions of Anaconda at this web page: https://repo.anaconda.com/archive/  The most recent python 3.7 version is anaconda3-2020-02
...
<br>
<b>=====  Run a single input file  ===== </b>
<br>

To run a single input file, you can use the following command:

	> python Run_Case_Example_default.py

where you need to specify the input file in the script.