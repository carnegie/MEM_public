...
def run_model_main_fun(case_dic, tech_list):
    ...
    [[input_case_dic,  input_tech_list,  input_time_dic],
     [results_case_dic,results_tech_dic,results_time_dic]] = save_basic_results(case_dic, tech_list,constraint_list, cvxpy_constraints,prob_dic,capacity_dic,dispatch_dic,stored_dic)
