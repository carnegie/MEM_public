...
fig = plt.figure(figsize = (14,7.5)) #17.5,11 for 3 storage techs
...
ax4 = fig.add_subplot(num_storage, 2, 4,sharey = ax1)
...
#ax6.legend(loc='upper center', bbox_to_anchor=(1.07, .98),frameon = False, fontsize = 'x-large')
...
fig.text(0.015,0.95,'a)', size = 'x-large')
fig.text(0.455,0.95,'b)', size = 'x-large')
fig.text(0.015,0.47,'c)', size = 'x-large')
fig.text(0.455,0.47,'d)', size = 'x-large')
#fig.text(0.015,0.65,'c)', size = 'x-large')
#fig.text(0.455,0.65,'d)', size = 'x-large')
#fig.text(0.015,0.31,'e)', size = 'x-large')
#fig.text(0.455,0.31,'f)', size = 'x-large')

plt.tight_layout(True)
plt.savefig('PaperFigures/SI/figure_s5_charge_discharge_no_LDS.jpg', dpi=300, bbox_inches='tight')
plt.show()
