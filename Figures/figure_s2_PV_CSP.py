...
with open('C:/Users/Kathleen/Desktop/Temp/SimpleCombos/2PV1_battery_20201209-174711.pickle', 'rb') as handle:
...
fig = plt.figure()
ax3 = plt.subplot2grid((6, 6), (0, 0), colspan=3, rowspan=2)
...
for i in range(num_storage):
    ...
    ax = plt.subplot2grid((6, 6), (0, 3+i), colspan=1, rowspan=2)
...
with open('C:/Users/Kathleen/Desktop/Temp/SimpleCombos/3CSP_PV2_batt_20210302-161500.pickle', 'rb') as handle:
            [[input_case,  input_tech,  input_time],
             [results_case, results_tech,  results_time]] = pickle.load(handle)
...
for i in range(num_storage):
    ...
    ax = plt.subplot2grid((6, 6), (2, 3+i), colspan=1, rowspan=2)
    ax.stackplot(x, y1, colors=pal1, labels=labels1)
    ax.stackplot(x, y2, colors=pal2, labels=labels2)
    ax.plot(x, demand_source1, '-', color=dem_c, linewidth=1.2)
...
with open('C:/Users/Kathleen/Desktop/Temp/SimpleCombos/3CSP_PV4_all_20210302-161335.pickle', 'rb') as handle:
            [[input_case,  input_tech,  input_time],
             [results_case, results_tech,  results_time]] = pickle.load(handle)
...
ax3 = plt.subplot2grid((6, 6), (4, 0), colspan=3, rowspan=2)
[l1,l2,l3,l4,l5] = ax3.stackplot(x, y1, colors=pal1, labels=labels1)
[l6,l7,l8,l9] = ax3.stackplot(x, y2, colors=pal2, labels=labels2)
ax3.plot(x, demand_source, '-', color=dem_c, linewidth=1.2)
ax3.set_xlim(quick_dates[0], quick_dates[-1])
ax3.set_ylim(-6,6.5)
ax3.spines['top'].set_visible(False)
...
for i in range(num_storage):
    ...
    ax = plt.subplot2grid((6, 6), (4, 3+i), colspan=1, rowspan=2)
    ax.stackplot(x, y1, colors=pal1, labels=labels1)
    ax.stackplot(x, y2, colors=pal2, labels=labels2)
    ax.plot(x, demand_source1, '-', color=dem_c, linewidth=1.2)
...
plt.figlegend(handles = (l1,l2,l3,l4,l5,l6), 
              labels = ('PV','CSP','TES','Battery','PGP','Demand'), 
              loc = 'upper right',frameon=False,fontsize='large')
fig.text(-.01, 0.5, 'Electricty sources and sinks (kW)', va='center', rotation='vertical', size=18 )

fig.text(.05, 0.97, 'a)', size='x-large')
fig.text(.54, 0.97, 'b)', size='x-large')
fig.text(.05, 0.63, 'c)', size='x-large')
fig.text(.54, 0.63, 'd)', size='x-large')
fig.text(.72, 0.63, 'e)', size='x-large')
fig.text(.05, 0.30, 'f)', size='x-large')
fig.text(.54, 0.30, 'g)', size='x-large')
fig.text(.72, 0.30, 'h)', size='x-large')
fig.text(.89, 0.30, 'i)', size='x-large')

plt.tight_layout(True)
plt.savefig('PaperFigures/SI/figure_s1_pv_csp_comp.jpg', dpi=300, bbox_inches='tight')
plt.show()
