# -*- coding: utf-8 -*-
"""
Created on Fri Jan  8 11:47:53 2021

@author: Kathleen
"""
##==============================================
# System Cost Sensitivity to percent renewable
##==============================================
...
##====================================================
'''
file_path = 'C:/Users/Kathleen/Downloads/MEM-master/MEM-master/Output_Data/CCS'
target = r'C:/Users/Kathleen/Desktop/Temp/CCSCO2Const'
...
'''
#====================================================================
# Read CCS data from each pickle file
##===================================================================
...
cases = os.listdir('C:/Users/Kathleen/Desktop/Temp/CCSCO2Const')

for case in cases:
    pickle_in = open('C:/Users/Kathleen/Desktop/Temp/CCSCO2Const/' + case, 'rb')
    ...
    natgas_disp = np.sum(results_time['natgas_ccs dispatch'])
...
'''
disps = np.array([100,99.5,99,97,95,90,85,80,60,50,40,20,17,14,10,5,3])
x_axis = 1 - 0.5**( np.log(disps/100.)/np.log(0.2) )
tick_labs, tick_locs = [], []
for i, disp in zip(x_axis, disps):
    #print(i, disp)
    if round(disp, 5) in [100., 50., 20., 10., 4., 1., 0.0]:
        tick_labs.append(str(int(100. - disp))+'%')
        tick_locs.append(i)
print(tick_locs)
print(tick_labs)
'''
...
ax2.set_xlabel('% Dispatch from Natural Gas w/ CCS')

plt.tight_layout(True)
plt.savefig('PaperFigures/SI/figure_s11_percent_renewable.jpg', dpi=300, bbox_inches='tight')
plt.show()
