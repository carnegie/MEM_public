...
inputs[7]: from_PGP
inputs[8]: 3rd_tech_energy
inputs[9]: 3rd_tech_power
tech_list[0]: demand
...
storage_tech = ['battery', 'to_PGP', 'PGP_storage', 'from_PGP', 'third_tech']
energy_tech = ['battery', 'PGP_storage', 'third_tech']
parameters = ['fixed_cost', 'capacity', 'dispatch', 'stored']


def get_data_non_sep_power(path, techidx1, var1, techidx2, var2, nones):
    ...
    for base in base_list:
        ...
        data['third_tech_cost'].append(add(dic.get('third_tech')))
    ...
    data['third_tech_cycles'] = calculate_cycles(data, 'third_tech', 'third_tech', nones)
