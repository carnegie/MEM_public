...
main_path = 'C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna//Output_Data/MISO/'
'''
##########################################################################
...
for i,e in enumerate([0, 1, 2, 3]):
  ...
  #if dur == 0 or cyc == 0:
    #continue
  if cyc == 0: #use for metal-air only
    continue
...
fig.text(-0.02, 0.5, 'Energy in storage (hours of mean MISO demand)', va='center', ha='center', 
...
if not os.path.exists('Figures'):
    os.makedirs('Figures')
plt.savefig('C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Dom Plotting Code/Plots/Fig 4/MISO/Fig_4_energy_storage_MISO_Metal-Air.png', bbox_inches='tight', dpi=900)
plt.show()