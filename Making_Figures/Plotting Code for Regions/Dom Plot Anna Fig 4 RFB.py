...
if not os.path.exists('Figures'):
    os.makedirs('Figures')
plt.savefig('C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Dom Plotting Code/Plots/Fig 4/Plots before GIMP Processing/ISO-NE/Fig_4_energy_storage_ISO-NE_RFB.png', bbox_inches='tight', dpi=900)
plt.show()