...
plt.savefig('C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Dom Plotting Code/Plots/Fig 2/Fig 2 CONUS proper y axis decimals.png', dpi=900, bbox_inches='tight')
plt.show()
