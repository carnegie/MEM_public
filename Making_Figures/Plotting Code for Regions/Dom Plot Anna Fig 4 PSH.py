...
main_path = 'C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Output_Data/For Figs 3 and 4/ISNE/'
...
fig.text(-0.02, 0.5, 'Energy in storage (hours of mean ISO-NE demand)', va='center', ha='center', 
...
if not os.path.exists('Figures'):
    os.makedirs('Figures')
plt.savefig('C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Dom Plotting Code/Plots/Fig 4/Plots before GIMP Processing/ISO-NE/Fig_4_energy_storage_ISO-NE_PSH.png', bbox_inches='tight', dpi=900)
plt.show()