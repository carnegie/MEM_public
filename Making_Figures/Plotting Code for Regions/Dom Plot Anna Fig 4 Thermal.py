...
main_path = 'C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Output_Data/For Figs 3 and 4/ERCO/'
...
fig.text(-0.02, 0.5, 'Energy in storage (hours of mean ERCOT demand)', va='center', ha='center', 
...
if not os.path.exists('Figures'):
    os.makedirs('Figures')
plt.savefig('C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Dom Plotting Code/Plots/Fig 4/Plots before GIMP Processing/ERCOT/Fig_4_energy_storage_ERCOT_Thermal.png', bbox_inches='tight', dpi=900)
plt.show()