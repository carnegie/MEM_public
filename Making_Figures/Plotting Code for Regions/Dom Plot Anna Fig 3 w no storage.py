...
#No Storage
no_storage_directory = 'C:/Users/covel/OneDrive/Desktop/Rerun-for-Anna/Output_Data/CISO/no_storage'

no_storage_techs = ['no_storage_CISO']
...
#ax2.text(-0.15, 1.05, '3.79', transform=ax2.transAxes, fontsize=9)
#ax3.text(-0.28, 1.05, '3.89', transform=ax3.transAxes, fontsize=9)
