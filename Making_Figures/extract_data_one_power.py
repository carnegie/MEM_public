...
storage_tech = ['battery', 'to_PGP', 'PGP_storage', 'from_PGP', 'third_tech_energy', 'third_tech_power']
energy_tech = ['battery', 'PGP_storage', 'third_tech_energy']
parameters = ['fixed_cost', 'capacity', 'dispatch', 'stored']
# storage_tech_idx = [3, 4, 5, 6, 8, 7]
storage_tech_idx = [4, 5, 6, 7, 9, 8]
